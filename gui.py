...
top.configure(background='#4B0082')
...
def classify_image(file_path):
    ...
    pred=numpy.argmax(prediction,axis=1)[0]
    print('model',pred)
    sign = classes[pred+1]
    print(sign)
...
title = Label(top, text="Traffic Sign Recognition",pady=20, font=('arial',20,'bold'))
title.configure(background='#4B0082',foreground='WHITE')
title.pack()
top.mainloop()
